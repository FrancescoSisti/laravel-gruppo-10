...
<div class="container">
    ...
    @csrf
        <div class="my-1">
            <label for="post-title" class="form-label ps-2">Nome Post:</label>
        ...
        <div class="my-1">
            <label for="post-content" class="form-label ps-2">Contenuto del Post:</label>
            <input type="text" class="form-control" id="post-content" name="content" value="{{ old('content') }}">
            @error("content")
                <div class="alert alert-warning">
                    {{ $message }}
                </div>
